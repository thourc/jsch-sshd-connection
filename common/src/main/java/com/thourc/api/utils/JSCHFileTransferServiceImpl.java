...
@Service
@Slf4j
public class JSCHFileTransferServiceImpl implements FileTransferService {
    ...
    public JSCHFileTransferServiceImpl(FileTransferConfigurationLoad fileTransferConfigurationLoad) {
